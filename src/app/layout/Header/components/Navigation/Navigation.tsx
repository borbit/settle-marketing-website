...
import { purchaseOrderCreationUrl, partnersPageUrl, fullCalculatorUrl } from '@lib/consts/externalLinks'
import {
      ...
      <ul className={clsx('flex', hamburgerMode ? 'flex-col items-start' : 'items-center gap-6')}>
        ...
        <NavigationGroup
          ...
          dropdown={[
            ...
            { label: 'PO Creation Tool', href: purchaseOrderCreationUrl },
            { label: 'Working Capital Calculator', href: fullCalculatorUrl },
            { label: 'Our Partners', href: partnersPageUrl },
          ]}
        >
          Resources
        </NavigationGroup>
